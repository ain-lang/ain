...
### 🤖 Body & Sensors (육체 & 센서)
> 📚 **상세 하드웨어 목록**: [docs/hardware-catalog.md](docs/hardware-catalog.md) (🔒 보호됨)

| 카테고리 | 추천 제품 | 가격대 |
|----------|----------|--------|
| 🚗 이동형 로봇 | **PiCar-X** ⭐ | ~15만원 |
| 🦾 로봇 팔 | **myCobot 280** ⭐ | ~70만원 |
| 🐕 4족 보행 | **Petoi Bittle** ⭐ | ~35만원 |
| 👁️ 카메라 | Pi Camera V3 / RealSense | ~5-25만원 |
| 👂 마이크 | ReSpeaker 어레이 | ~10만원 |
| 🗣️ 스피커 | USB/Bluetooth | ~3-10만원 |
| 🖐️ 센서 | 압력/온도/초음파 | ~1-2만원 |

---

### 🌐 Web & Communication (소프트웨어)
